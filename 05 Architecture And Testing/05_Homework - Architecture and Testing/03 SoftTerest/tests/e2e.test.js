...
const host = 'http://127.0.0.1:5500/05%20Architecture%20And%20Testing/05_Homework%20-%20Architecture%20and%20Testing/03%20SoftTerest/index.html'; // Application host (NOT service host - that can be anything)
const DEBUG = false;
...
describe('E2E tests', function () {
    ...
    describe('Catalog', () => {
        it('show most recent ideas', async () => {
            ...
            expect(titles[0]).to.contains('Best Pilates Workout To Do At Home');
            expect(titles[1]).to.contains('4 Eady DIY Idea To Try!');
            expect(titles[2]).to.contains('Dinner Recipe');
        });
        ...
        it('show idea details', async () => {
            ...
            await page.click('text=Dashboard');
            await page.waitForSelector('#dashboard-holder');
            await page.click('div.card:has-text("Best Pilates Workout To Do At Home") >> text=Details');
        ...
        it('guest does NOT see delete button', async () => {
            ...
            await page.waitForSelector('#dashboard-holder');
            await page.click('div.card:has-text("Best Pilates Workout To Do At Home") >> text=Details');
            await page.waitForSelector('h2:has-text("Best Pilates Workout To Do At Home")');
    ...
    describe('CRUD', () => {
        ...
        it('delete makes correct API call for logged in user', async function() {
